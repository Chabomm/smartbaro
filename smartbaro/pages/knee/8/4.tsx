...
const knee_8_4: NextPage = (props: any) => {
    const nav_id = '/knee/8/4';
    const nav_name = '연골판 줄기세포치료술';
    ...
    return (
        <Layout title={nav_name} nav_id={nav_id} device={props.device}>
            ...
            <div className="subject sub-py">연골판 줄기세포치료술</div>
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'knee/8/', name: '4.html' };
    var response: any = {};
    try {
