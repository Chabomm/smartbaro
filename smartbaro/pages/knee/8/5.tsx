...
const knee_8_5: NextPage = (props: any) => {
    const nav_id = '/knee/8/5';
    ...
    return (
        <Layout title={nav_name} nav_id={nav_id} device={props.device}>
            ...
            <div className="subject sub-py">1day관절내시경수술</div>
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'knee/8/', name: '5.html' };
    var response: any = {};
    try {
