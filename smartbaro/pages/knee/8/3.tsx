...
const knee_8_3: NextPage = (props: any) => {
    const nav_id = '/knee/8/3';
    const nav_name = '전후방십자인대 재건수술';
    ...
    return (
        <Layout title={nav_name} nav_id={nav_id} device={props.device}>
            ...
            <div className="subject sub-py">전후방십자인대 재건수술</div>
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'knee/8/', name: '3.html' };
    var response: any = {};
    try {
