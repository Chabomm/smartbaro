...
import SubMenuKnee from '@/components/submenu/knee';

const knee_3: NextPage = (props: any) => {
    const nav_id = '/knee/3';
    const nav_name = '반월상연골판손상';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'knee', name: '3.html' };
    var response: any = {};
    try {
