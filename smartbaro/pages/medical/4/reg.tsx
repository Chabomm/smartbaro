...
const Medical_4_reg: NextPage = (props: any) => {
            ...
            <form onSubmit={fn.handleSubmit} noValidate>
                <section className="site-width reserve-wrap">
                    <div className="site-width reserve-item">
                        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-5 normal-text">
                            <div className="pb-7">
                ...
                <section className="site-width sub-py">
                    <div className="">
                        <div className="button-group grid-cols-3 ">
                            <div
                                onClick={() => {
                                    goBack();
                                }}
