...
const Screening_3_4: NextPage = (props: any) => {
    const nav_id = '/screening/3/4';
    const nav_name = '국가시험면허진단서발급';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/3/', name: '4.html' };
    var response: any = {};
    try {
