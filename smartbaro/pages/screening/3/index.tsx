...
const Screening_3_index: NextPage = (props: any) => {
    const nav_id = '/screening/3/1';
    const nav_name = '건강검진안내';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/3/', name: '1.html' };
    var response: any = {};
    try {
...
export default Screening_3_index;
