...
const Screening_3_2: NextPage = (props: any) => {
    const nav_id = '/screening/3/2';
    const nav_name = '종합검진프로그램';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/3/', name: '2.html' };
    var response: any = {};
    try {
