...
const Screening_2: NextPage = (props: any) => {
    const nav_id = '/screening/2';
    const nav_name = '갑상선외과센터';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/', name: '2.html' };
    var response: any = {};
    try {
