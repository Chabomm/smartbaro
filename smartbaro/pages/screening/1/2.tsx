...
const Screening_1_2: NextPage = (props: any) => {
    const nav_id = '/screening/1/2';
    const nav_name = '심혈관질환';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/1/', name: '2.html' };
    var response: any = {};
    try {
