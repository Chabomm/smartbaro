...
const Screening_1_3: NextPage = (props: any) => {
    const nav_id = '/screening/1/3';
    const nav_name = '내분비질환';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/1/', name: '3.html' };
    var response: any = {};
    try {
