...
const Screening_1_4: NextPage = (props: any) => {
    const nav_id = '/screening/1/4';
    const nav_name = '초음파검사';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'screening/1/', name: '4.html' };
    var response: any = {};
    try {
