...
const termsProvision: NextPage = (props: any) => {
    const nav_id = '/terms/provision';
    const nav_name = '환자권리장전';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'terms', name: 'provision.html' };
    var response: any = {};
    try {
