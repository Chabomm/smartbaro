...
const termsPrivacy: NextPage = (props: any) => {
    const nav_id = '/terms/privacy';
    const nav_name = '개인정보 처리방침';
    ...
    return (
        <Layout title={nav_name} nav_id={nav_id} device={props.device}>
            ...
            <div className=" text-justify" dangerouslySetInnerHTML={{ __html: props.response }}></div>
        </Layout>
    );
};
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'terms', name: 'privacy.html' };
    var response: any = {};
    try {
