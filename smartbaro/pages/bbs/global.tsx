...
const FrontBoardGlobal: NextPage = (props: any) => {
    const nav_id = '/bbs/global';
    const nav_name = '해외의료교류';
    ...
    return (
        <Layout title={nav_name} nav_id={nav_id} device={props.device}>
            ...
            <BoardPostGallery board_uid={5} hidden_date={true} device={props.device} />
        </Layout>
    );
};
...
export default FrontBoardGlobal;
