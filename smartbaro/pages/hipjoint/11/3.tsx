...
const Hipjont_11_3: NextPage = (props: any) => {
    const nav_id = '/hipjoint/11/3';
    const nav_name = '신경차단술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'hipjoint/11/', name: '3.html' };
    var response: any = {};
    try {
