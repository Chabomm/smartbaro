...
const Hipjont_11_5: NextPage = (props: any) => {
    const nav_id = '/hipjoint/11/5';
    const nav_name = '고관절인공관절 수술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'hipjoint/11/', name: '5.html' };
    var response: any = {};
    try {
