...
const Hipjont_11_6: NextPage = (props: any) => {
    const nav_id = '/hipjoint/11/6';
    const nav_name = '최소침습 척추고정술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'hipjoint/11/', name: '6.html' };
    var response: any = {};
    try {
