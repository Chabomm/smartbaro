...
const Hipjont_11_2: NextPage = (props: any) => {
    const nav_id = '/hipjoint/11/2';
    const nav_name = '4無신경성형술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'hipjoint/11/', name: '2.html' };
    var response: any = {};
    try {
