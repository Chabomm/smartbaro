...
const Hipjont_11_4: NextPage = (props: any) => {
    const nav_id = '/hipjoint/11/4';
    const nav_name = '고주파수액감압술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'hipjoint/11/', name: '4.html' };
    var response: any = {};
    try {
