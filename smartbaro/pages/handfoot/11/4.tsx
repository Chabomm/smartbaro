...
const Handfoot_11_4: NextPage = (props: any) => {
    const nav_id = '/handfoot/11/4';
    const nav_name = '전거비인대파열수술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'handfoot/11/', name: '4.html' };
    var response: any = {};
    try {
