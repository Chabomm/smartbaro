...
const Handfoot_11_5: NextPage = (props: any) => {
    const nav_id = '/handfoot/11/5';
    const nav_name = '무지외반증수술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'handfoot/11/', name: '5.html' };
    var response: any = {};
    try {
