...
const Handfoot_11_1: NextPage = (props: any) => {
    const nav_id = '/handfoot/11/1';
    const nav_name = '1day 골절정복수술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'handfoot/11/', name: '1.html' };
    var response: any = {};
    try {
