...
const Handfoot_11_3: NextPage = (props: any) => {
    const nav_id = '/handfoot/11/3';
    const nav_name = '아킬레스파열재건수술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'handfoot/11/', name: '3.html' };
    var response: any = {};
    try {
