...
import SubMenuHandfoot from '@/components/submenu/handfoot';

const Handfoot_3: NextPage = (props: any) => {
    const nav_id = '/handfoot/3';
    const nav_name = '테니스엘보우';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'handfoot', name: '3.html' };
    var response: any = {};
    try {
