...
const shoulder_1: NextPage = (props: any) => {
    const nav_id = '/shoulder/1';
    const nav_name = '오십견(유착성관절낭염)';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'shoulder', name: '1.html' };
    var response: any = {};
    try {
