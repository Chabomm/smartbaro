...
const shoulder_8_3: NextPage = (props: any) => {
    const nav_id = '/shoulder/8/3';
    const nav_name = '견봉석회화 성형술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'shoulder/8/', name: '3.html' };
    var response: any = {};
    try {
