...
const shoulder_8_2: NextPage = (props: any) => {
    const nav_id = '/shoulder/8/2';
    const nav_name = '회전근개 이열봉합술';
...
export const getServerSideProps: GetServerSideProps = async ctx => {
    ...
    var request: any = { path: 'shoulder/8/', name: '2.html' };
    var response: any = {};
    try {
